...
INSERT INTO "new_Recruit" ("createdAt", "description", "id", "name", "salary", "updatedAt", "userId") SELECT "createdAt", "description", "id", "name", "salary", "updatedAt", "userId" FROM "Recruit";
DROP TABLE "Recruit";
