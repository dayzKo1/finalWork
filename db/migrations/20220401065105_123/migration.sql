...
INSERT INTO "new_Resume" ("advance", "age", "cert", "createdAt", "educ", "gender", "id", "inte", "lang", "number", "prefer", "proj", "skil", "status", "stud", "updatedAt", "userId") SELECT "advance", "age", "cert", "createdAt", "educ", "gender", "id", "inte", "lang", "number", "prefer", "proj", "skil", "status", "stud", "updatedAt", "userId" FROM "Resume";
DROP TABLE "Resume";
